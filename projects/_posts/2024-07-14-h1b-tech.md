...
<div class="message">
  Check out <a href="https://github.com/nikhilgahlawat/immigration-h1b">Github</a> for the code used to clean and analyze data found in this story.
</div>
...
Compared to border crossings, the number of H-1Bs is relatively small. In 2023, around 120,000 new H-1B visas were issued versus 2.5 million migrant encounters at the border. 

Though fewer in number, foreign guest workers have an outsized impact on the US economy, and on one industry in particular.

Technology companies have been taking a larger share of available H-1B visas. In 2023, tech companies received 4x as many visas compared to 15 years earlier. Half of the 10 largest H-1B recipients that year were companies in the tech industry, and 11 of the largest tech companies declared that at least 15% of their employees were on H-1B visas.

Tech’s growing reliance on the program pits two competing factors against one another: the desire to remain globally competitive in critical technologies and an emerging isolationism eager to shut down the border and protect US workers.

This tension scrambles the normal political divides. Far-right Republicans fighting to shut down the border find themselves on the same side as pro-labor progressives arguing to pare down a program they believe harms US workers. Meanwhile, free-market conservatives as well as Democrats with close ties to the tech industry want to open the gates wider by eliminating limits on the number of new visas.

Any reform will have far-reaching consequences. Some of the companies that are most reliant on H-1B visas are at the center of a global battle for dominance in critical technologies. And foreign workers who wish to stay in the US after their visas expire are placed in an overstuffed green card backlog where the wait time is sometimes measured in decades.

The calls for reform are mounting. To see what the future might hold for the H-1B program - and the guest workers at its heart - it may help to start with its past.
...
The program has been wildly popular with employers. Every year, tens of thousands of companies petition U.S. Citizenship and Immigration Services (USCIS) for one or more H-1B visas. The USCIS limits the number of new visas available for most companies[^fn-cap-exempt] to 85,000 each year, but they almost always receive more petitions than available slots - sometimes [nearly 9-times](https://www.cato.org/blog/h-1b-lottery-results-announced-3/4-rejected) as many - leaving them to run a lottery system to dole out new visas. 
...
While outsourcing companies reeled from the administration’s crackdown, tech companies were barely touched. Denial rates for the largest tech companies remained essentially flat, peaking at just 3% in 2019. Instead, big tech companies doubled their volume of H-1B visa approvals between 2016 and 2020. Over the 15 year period from 2009 to 2023, total visa approvals for big tech companies were up over 300%.
...
Despite the tech industry’s emergence as a prominent user of H-1B visas, though, many of the proposed changes are likely to continue hitting outsourcing companies hardest.
...
Wages are broken out by how they compare to the local median wage of similar occupations.
Level 1: 17th percentile of local median wage | Level 2: 34th percentile | Level 3: 50th percentile | Level 4: 67th percentile
</span>

If reforms do pass, they will likely continue targeting outsourcing companies, clearing the way for big tech to continue taking more of the visa pool, as they have been over the past 15 years. But H-1B reform alone deals only with how and which foreign workers get to come to the US. What happens after they’re here?
...
And when that industry goes through rocky times, as the tech industry did in 2022 and 2023, all those workers compete for new jobs at the same time. Some of the companies with the most H-1B workers laid off the most employees. According to [Layoffs.fyi](https://layoffs.fyi/), Amazon has laid off over 27,000 workers since 2022. Meta has laid off 21,000. Google has laid off over 13,000.

While there’s no widely available data on how many of those let go were on H-1B visas, Layoffs.fyi does provide crowdsourced lists of individuals who lost their jobs, mostly as visibility for recruiters who might be hiring. The list for two companies, TikTok and Tesla, provide a space for workers to indicate whether they require sponsorship from their next employer. Of those who completed that field, roughly a quarter said they would need sponsorship.
...
The question of what to do with the H-1B program remains a thorny corner of immigration reform, one that often gets lost amidst the border crisis. In 2016, Donald Trump campaigned on building a wall to keep out would-be immigrants. Not long after, the U.S. Border Patrol’s “zero tolerance” policy put [families in cages](https://apnews.com/article/9794de32d39d4c6f89fbefaea3780769). Against images like these, little else can stand out.
...
At the center of it all, workers who have become cornerstones of an industry building the most critical technologies of the future are still waiting for relief.



-----

[^fn-cap-exempt]: Nonprofit research organizations, universities, and teaching hospitals are among those exempt from the cap, meaning the number of new visas is usually much higher than 85,000.
